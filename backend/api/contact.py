...
def _send_contact_email(req: ContactFormRequest) -> None:
    ...
    smtp_from = os.environ.get("SMTP_FROM", smtp_user or "noreply@jyotishasutra.ai")
...
<head>
  <meta charset="utf-8">
  <title>New Contact Query – JyotishaSutra AI</title>
</head>
  ...
  <div style="max-width:600px;margin:40px auto;background:#fff;border-radius:20px;
    ...
    <div style="padding:32px;">
      <p style="font-size:15px;color:#555;margin-top:0;">
        You have received a new query through the JyotishaSutra AI contact page.
      </p>
      ...
      <div style="text-align:center;margin-top:32px;">
        <a href="mailto:{req.email}?subject=Re: Your query to JyotishaSutra AI"
    ...
    <div style="padding:20px 32px;border-top:1px solid #E9DFC8;
      ...
      <p style="margin:0;font-size:11px;color:#B0A090;">
        JyotishaSutra AI · Powered by <strong>manasai.tech</strong> · ISS Delhi
      </p>
    </div>
  </div>
</body>
...
"""
    ...
    if smtp_host and smtp_port and smtp_user and smtp_pass:
        ...
        msg["Subject"] = f"📬 New Contact Query from {req.name} – JyotishaSutra AI"
        msg["From"]    = f"JyotishaSutra AI <{smtp_from}>"
