...
export const TIER_CONFIG: Record<SubscriptionTier, TierConfig> = {
  ...
  pro: {
    ...
    borderColor: '#C89B3C',
    allowedTabs: ['overview', 'career', 'dasha_timeline', 'personality', 'health', 'remedies', 'food', 'finance', 'marriage', 'matching', 'spiritual', 'doshas', 'strategic_insights', 'past_events', 'wounds_trauma', 'gifts_talents', 'soul_growth'],
    ...
    features: [
      ...
      '💔 Wounds & Trauma — Past-Life & Family Karma',
      '💎 Gifts & Talents — Innate Abilities & Past-Life Gifts',
      '🌱 Soul Growth — Karmic Lessons & Dharmic Purpose',
