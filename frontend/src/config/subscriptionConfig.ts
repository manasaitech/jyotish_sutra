...
export const TIER_CONFIG: Record<SubscriptionTier, TierConfig> = {
  ...
  standard: {
    ...
    borderColor: '#E67E22',
    allowedTabs: ['overview', 'career', 'dasha_timeline', 'personality', 'health', 'marriage', 'matching', 'food', 'doshas'],
    dailyChatLimit: 25,
    maxProfiles: 3,
    allowPrashna: false,
    allowBTR: true,
  ...
  pro: {
    ...
    borderColor: '#C89B3C',
    allowedTabs: ['overview', 'career', 'dasha_timeline', 'personality', 'health', 'remedies', 'food', 'finance', 'marriage', 'matching', 'spiritual', 'doshas'],
